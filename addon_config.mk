...
meta:
	ADDON_NAME = ofxAudioAnalysisClient
	ADDON_DESCRIPTION = A component of a Jamulus to Drawing Machine process
	ADDON_AUTHOR = @smeyfroi
	ADDON_TAGS = "addon"
	ADDON_URL = http://github.com/smeyfroi/ofxAudioAnalysisClient

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxNetwork ofxOsc ofxHistoryPlot ofxGist ofxSoundObjects
